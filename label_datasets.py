...
class LabelDatasets:
	...
	def create_gui(self):
		...
		self.activities_frame.grid(row=0, column=0, padx=5, pady=5)

		### RANGE EDITING/CONFIRMING ###

		# current selected range(s) for selected activity
		self.current_range_selections = tk.Text(self.range_edits_frame, bg="white", width=60, height=5)
		...
		self.range_edits_frame.grid(row=1, column=0, padx=5, pady=5)
